...
<div style={{position:'relative',paddingBottom:'calc(56.25% + 58px)',height:0,overflow:'hidden',maxWidth:'100%'}}><iframe src="https://app.ludus.one/634ef6b9-4ed2-420d-b24f-333574e625f2/full?controls=always" frameBorder="0" allowFullScreen style={{position:'absolute',top:0,left:0,width:'100%',height:'100%'}}></iframe></div>
