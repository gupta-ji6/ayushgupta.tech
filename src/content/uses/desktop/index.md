---
title: 'Apps'
subtitle: 'Applications and tools I use to get things done, fast and fun!'
order: 2
---
...
- [~Arc~](https://arc.net/) (exploring [Zen Browser](https://zen-browser.app/) instead)
...
- [Warp Terminal](https://app.warp.dev/referral/NPG953)
- [XCode](https://developer.apple.com/xcode/)
- [Xcodes](https://www.xcodes.app/)
- [Android Studio](https://developer.android.com/studio)
- [Expo Orbit](https://www.expo.dev/orbit)
...
- [Freeform](https://support.apple.com/en-in/guide/freeform/frfm85d6f7b58/mac)
...
- [Better Display](https://betterdisplay.pro/)
- [~Hand Mirror~](https://handmirror.app/) (now replaced with [Raycast Camera Preview](https://www.raycast.com/changelog/1-63-0))
