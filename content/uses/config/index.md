---
title: 'Config'
subtitle: 'Editor, shell and programming configurations I generally prefer to use. Still a work in progress.'
order: 4
---
...
- Font - [Cascadia Code](https://github.com/microsoft/cascadia-code) / [Operator Mono](https://www.typography.com/fonts/operator/styles) / [Fira Code](https://github.com/tonsky/FiraCode)
...
- [Expo Tools](https://marketplace.cursorapi.com/items?itemName=expo.vscode-expo-tools)
